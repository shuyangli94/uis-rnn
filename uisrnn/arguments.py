...
def parse_arguments():
    ...
    training_parser.add_argument(
        ...
        help='Re-train an existing model if it exists'
    )
    training_parser.add_argument(
        '--optimizer',
        '-o',
    ...
    data_parser.add_argument(
        '--train-seq',
        type=str,
        help='Training d-vector sequences'
    )
    data_parser.add_argument(
        '--train-clusters',
        type=str,
        help='Training cluster ID labels'
    )
    data_parser.add_argument(
        '--test-seq',
        type=str,
        help='Testing d-vector sequences'
    )
    data_parser.add_argument(
        '--test-clusters',
        type=str,
        help='Testing cluster ID labels'
    )
    ...
    return (model_args, training_args, inference_args, data_args)
